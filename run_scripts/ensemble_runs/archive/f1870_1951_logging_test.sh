...
CASE_TAG="logging_test_050824"
FATES_PARAM_DIR="/glade/u/home/adamhb/ahb_params/fates_api_25/ensembles/ml_supported_ensemble_2560_050224_04" #Full path to parameter directory
USER_NINST=128
USER_RUN_REFDATE="1320-01-01"
USER_RUN_REFCASE="ml_supported_ensemble_050224_04_-17e2acb6a_FATES-1449c787"
...
#export PARAM_DIR=${PARAM_DIR_BASE}/ensembles/${FATES_PARAM_DIR}
export PARAM_DIR=${FATES_PARAM_DIR}
...
export SITE_BASE_PATH="/glade/work/adamhb/input_data" # dir for site datasets
...
# Output settings
export SIMUL_ROOT="/glade/derecho/scratch/adamhb" # dir to put output
...
./xmlchange RUN_REFDATE=${USER_RUN_REFDATE}
...
./xmlchange RUN_STARTDATE="1320-01-01"
