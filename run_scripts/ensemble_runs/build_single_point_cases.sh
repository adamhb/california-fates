...
#Name the case
export CASE_NAME="CZ2_equilibrium_101723_$case_number"
export NINST=36
...
export PARAM_FILE_BASE_NAME=CZ2_equilibrium_101723

# Directory where the parameter files are stored
export PARAM_DIR_BASE=${HOME}/ahb_params/fates_api_25
export PARAM_DIR=${PARAM_DIR_BASE}/ensembles/CZ2_equilibrium_101723_$case_number
