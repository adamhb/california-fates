...
export CASE_PREFIX="oak-woodland-test-bark-resp-trans"
...
export HLM_FINIDAT="strip-test-bark-resp_CLM_FATES.clm2.r.2023-01-01-00000.nc"
#export HLM_FINIDAT=""
...
#---~---
export FATES_PARAMS_BASE="oakgrass-AVBA-N05T26.cdl"
#---~---
...
then
   hlm_settings=("hist_empty_htapes .true."
                 ...
                 "hist_fincl1       'BTRAN','BTRANMN','EFLX_SOIL_GRND',\
                                    ...
                                    'FATES_CROWNAREA_PF','FATES_CANOPYCROWNAREA_PF',\
