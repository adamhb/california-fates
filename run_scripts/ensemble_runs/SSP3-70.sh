...
# Set driver data
export SITE_NAME="CZ2_wrf_ssp370" # dir for site-specific datasets
...
co2tseries.SSP3-7.0:year_first=2015
co2tseries.SSP3-7.0:year_align=2015
EOF
