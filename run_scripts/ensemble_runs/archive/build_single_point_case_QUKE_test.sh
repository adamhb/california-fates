...
#Name the case
export CASE_NAME="QUKE-ensemble-081523"
export NINST=72
...
export PARAM_FILE_BASE_NAME=black_oak_test_081523

# Directory where the parameter files are stored
export PARAM_DIR_BASE=${HOME}/ahb_params/fates_api_25
export PARAM_DIR=${PARAM_DIR_BASE}/ensembles/black_oak_ensemble_081523
