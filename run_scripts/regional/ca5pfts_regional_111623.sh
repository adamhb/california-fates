...
export SITE_BASE_PATH="/glade/work/adamhb/input_data"
# Sub-directory with data sets specific to this site.
export SITE_NAME="CA"
# mesh file (it must be in the SITE_NAME sub-directory).
export HLM_USRDAT_DOMAIN="ca_wrf_mesh.nc"
# land mask file
export HLM_USRDAT_MASK="CZ_mask_111623.nc"
#export HLM_USRDAT_MASK="wrf_CA_grass-woodland.nc"
# Surface data file (it must be in the SITE_NAME sub-directory).
export HLM_USRDAT_SURDAT="surfdata_wrf_CA_hist_16pfts_CMIP6_1981_c220715_updated_ahb_CZ2_domain.nc"
...
#---~---
./xmlchange NTASKS_ATM=71    # if use all processors give  -4
./xmlchange NTASKS_LND=71
./xmlchange NTASKS_ROF=71
./xmlchange NTASKS_ICE=71
./xmlchange NTASKS_OCN=71
./xmlchange NTASKS_CPL=71
./xmlchange NTASKS_GLC=71
./xmlchange NTASKS_WAV=71
...
then
   ...
   FATES_PARAMS_CASE=${FATES_PARAMFILE}
