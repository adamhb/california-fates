...
# NOTE THIS SCRIPT IS UNDER DEVELOPMENT. PICK UP WITH
# ADDING CODE TO CREATE NEW PARAM FILES HERE
...
if [make_param_file -eq 1] then

PARAM_FILE_NAME=ca_ahb_070723_young_seed_alloc_test
...
export PARAM_FILE_NAME=ca_ahb_5pfts_080623.nc

# Directory where the parameter files are stored
export PARAM_DIR=${HOME}/ahb_params/fates_api_25
export PARAM_FILE_PATH=${PARAM_DIR}/${PARAM_FILE_NAME}
...
fates_paramfile = '${PARAM_FILE_PATH}' 
use_fates = .true. 
